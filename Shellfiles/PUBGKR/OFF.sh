...
chmod -R 755 /data/data/com.pubg.krmobile/lib/libigshare.so
...
chmod -R 660 /data/data/com.pubg.krmobile/databases/pri_tencent_analysis.db
chmod -R 660 /data/data/com.pubg.krmobile/databases/tdm.db
chmod -R 660 /data/data/com.pubg.krmobile/databases/tencent_analysis.db
echo "🛡libgcloud.so✔"
